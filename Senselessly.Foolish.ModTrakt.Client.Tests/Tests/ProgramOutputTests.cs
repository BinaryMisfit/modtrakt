namespace Senselessly.Foolish.ModTrakt.Client.Tests.Tests
{
    ...
    public class ProgramOutputTests
    {
        ...
        [Fact]
        public async void Program_Arg_H_Returns_Help()
        {
        ...
        [Fact]
        public async void Program_Arg_Help_Returns_Help()
        {
            const string expected = "*Options:*--version*Show version information*";
            var rootCommand = _builder.BuildCommand();
        ...
        [Fact]
        public async void Program_Arg_None_Returns_Help()
        {
            const string expected = "*Options:*--version*Show version information*";
            var rootCommand = _builder.BuildCommand();
        ...
        [Fact]
        public async void Program_Arg_Version_Returns_Version()
        {
            var rootCommand = _builder.BuildCommand();
